            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('AtypikHouse by')}} <a href="{{__('https://f2i-dev2-dc-ib-rv-ch.fr/')}}" target="_blank">{{__('CIDR Agency')}}</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('#')}}" target="_blank">{{__('About Us')}}</a>
                            <a href="{{__('https://roterman.dev')}}" target="_blank">{{__('RR')}}</a>
                        </div>
                    </div>
                </div>
            </div>
