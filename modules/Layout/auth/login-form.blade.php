<form class="bravo-form-login" method="POST" action="{{ route('login') }}">
    ...
    <div class="form-group">
        <div class="d-flex justify-content-between">
            <label for="remember-me" class="mb0">
                <input type="checkbox" name="remember" id="remember-me" value="1"> {{__('Remember me on the AtypikHouse')}} <span class="checkmark fcheckbox"></span>
            </label>
    ...
    @endif
    <div class="c-grey font-medium f14 text-center"> {{__('Do not have an account on AtypikHouse?')}} <a href="" data-target="#register" data-toggle="modal">{{__('Sign Up. Its Free!')}}</a>
    </div>
</form>
